...
class MAFT_Plus_FreezeClipV(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        clip_feature = features['clip_vis_dense'] # 注意，在该实现里冻结了clipV故可以这样调用
        img_feat = self.visual_prediction_forward_convnext(clip_feature)    

        text_classifier = self.cdt(img_feat, text_classifier) # 将cdt提前
